                    ...
                    <div class="input-group">
                        <div class="col">
                            <div class="input-group mb-1">
                                ...
                                <input type="date" class="form-control" wire:model="date" aria-label="Default"
                ...
                <div class="modal-body">
                    <form id="formulario" wire:submit.prevent="store">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="any" name="precio_compra" placeholder="Ingresar el precio de compra" class="form-control" wire:model="precio_compra" autocomplete="off">
                            @error('precio_compra')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="any" name="precio_venta" wire:model="precio_venta" class="form-control" placeholder="Ingresar el precio de venta" autocomplete="off">
                            @error('precio_venta')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="stock" wire:model="stock" class="form-control" placeholder="Ingresar la cantidad del producto" autocomplete="off">
                            @error('stock')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        </div>
